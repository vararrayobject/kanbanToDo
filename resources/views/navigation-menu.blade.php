        ...
        <div class="hidden sm:flex sm:items-center sm:ml-6">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <img class="h-8 w-8 rounded-full object-cover"
                    src="{{ asset('/assets/img/alert-circle-outline.svg') }}" />
                {{-- </span> --}}
            </div>

            <span class="inline-flex rounded-md">
                <img class="h-8 w-8 rounded-full object-cover"
                    src="{{ asset('/assets/img/plus-circle-outline.svg') }}" />
            </span>
            <span class="inline-flex rounded-md">
                <img class="h-8 w-8 rounded-full object-cover" src="{{ asset('/assets/img/bell-outline.svg') }}" />
            </span>
            <div class="ml-3 relative">
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <span class="inline-flex rounded-md">
                            ...
                            <img class="h-8 w-8 rounded-full object-cover"
                                src="{{ asset('/assets/img/Oval@2x.png') }}" />
                        </span>
